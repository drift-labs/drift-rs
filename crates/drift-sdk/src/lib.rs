...
use crate::{
    ...
    drift_abi::traits::ToAccountMetas,
...
impl<'a> TransactionBuilder<'a> {
    ...
    pub fn deposit(
        ...
        let ix = Instruction {
            ...
            accounts,
            data: InstructionData::data(&drift_abi::instructions::Deposit {
    ...
    pub fn withdraw(
        ...
        let ix = Instruction {
            program_id: constants::PROGRAM_ID,
            accounts,
            data: InstructionData::data(&drift_abi::instructions::Withdraw {
                market_index: spot_market_index,
                amount,
                reduce_only: reduce_only.unwrap_or(false),
            }),
    ...
    pub fn place_orders(mut self, orders: Vec<OrderParams>) -> Self {
        ...
        let accounts = build_accounts(
            self.program_data,
            drift_abi::accounts::PlaceOrders {
                state: *state_account(),
                authority: self.authority,
                user: self.sub_account,
            },
        ...
        let ix = Instruction {
            program_id: constants::PROGRAM_ID,
            accounts,
            data: InstructionData::data(&drift_abi::instructions::PlaceOrders { params: orders }),
        };
    ...
    pub fn cancel_all_orders(mut self) -> Self {
        let accounts = build_accounts(
            self.program_data,
            drift_abi::accounts::CancelOrder {
                state: *state_account(),
                authority: self.authority,
                user: self.sub_account,
            },
        ...
        let ix = Instruction {
            program_id: constants::PROGRAM_ID,
            accounts,
            data: InstructionData::data(&drift_abi::instructions::CancelOrders {
                market_index: None,
                market_type: None,
                direction: None,
            }),
    ...
    pub fn cancel_orders_by_id(mut self, order_ids: Vec<u32>) -> Self {
        ...
        let ix = Instruction {
            program_id: constants::PROGRAM_ID,
            accounts,
            data: InstructionData::data(&drift_abi::instructions::CancelOrdersByIds { order_ids }),
        };
        self.ixs.push(ix);
    ...
    pub fn cancel_orders_by_user_id(mut self, user_order_ids: Vec<u8>) -> Self {
        ...
        for user_order_id in user_order_ids {
            let ix = Instruction {
                ...
                data: InstructionData::data(&drift_abi::instructions::CancelOrderByUserId {
                    user_order_id,
                }),
            };
            self.ixs.push(ix);
    ...
    pub fn place_and_make(
        ...
        let mut accounts = build_accounts(
            self.program_data,
            drift_abi::accounts::PlaceAndMakePerpOrder {
                state: *state_account(),
                authority: self.authority,
                user: self.sub_account,
                user_stats: Wallet::derive_stats_account(&self.authority, &constants::PROGRAM_ID),
        ...
        let ix = if order.market_type == MarketType::Perp {
            Instruction {
                program_id: constants::PROGRAM_ID,
                accounts,
                data: InstructionData::data(&drift_abi::instructions::PlaceAndMakePerpOrder {
                    params: order,
                    taker_order_id,
                }),
            }
            ...
            Instruction {
                program_id: constants::PROGRAM_ID,
                accounts,
                data: InstructionData::data(&drift_abi::instructions::PlaceAndMakeSpotOrder {
                    params: order,
                    taker_order_id,
                    fulfillment_type,
                }),
    ...
    pub fn place_and_take(
        ...
        let mut accounts = build_accounts(
            self.program_data,
            drift_abi::accounts::PlaceAndTakePerpOrder {
                state: *state_account(),
                authority: self.authority,
                user: self.sub_account,
                user_stats: Wallet::derive_stats_account(&self.authority, &constants::PROGRAM_ID),
        ...
        let ix = if is_perp {
            Instruction {
                program_id: constants::PROGRAM_ID,
                accounts,
                data: InstructionData::data(&drift_abi::instructions::PlaceAndTakePerpOrder {
                    params: order,
                    maker_order_id: None,
                }),
            }
            ...
            Instruction {
                program_id: constants::PROGRAM_ID,
                accounts,
                data: InstructionData::data(&drift_abi::instructions::PlaceAndTakeSpotOrder {
                    params: order,
                    maker_order_id: None,
                    fulfillment_type,
                }),
...
mod tests {
    ...
    use drift_abi::accounts::PerpMarket;
    use serde_json::json;
